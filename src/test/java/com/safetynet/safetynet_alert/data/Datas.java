...
public class Datas {
    ...
    public Datas(){
            this.persons = new ArrayList<>(List.of(
                    ...
                    new Person("Harper", "Allen", "505 Oak St", "Culver", "97451", "123-456-7911", "harper.allen@example.com"),
            ...
            this.medicalRecords = new ArrayList<>(List.of(
                ...
                new MedicalRecord("Jackson", "Harris", LocalDate.of(1987, 2, 17), List.of("Aspirin"), List.of("Dust", "Milk")),
                new MedicalRecord("Harper", "Allen", LocalDate.of(1994, 10, 30), List.of("Metformin", "Lisinopril"), List.of("Eggs", "Wheat")),
